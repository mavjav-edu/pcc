...
\>\>\> <span class="codestrong">message = "I really like dogs."</span>  
\>\>\> <span class="codestrong">message.replace('dog', 'cat')</span>  
'I really like cats.'
...
\>\>\> <span class="codestrong">line = "Row, row, row your
boat"</span>  
\>\>\> <span class="codestrong">line.count('row')</span>  
2  
\>\>\> <span class="codestrong">line.lower().count('row')</span>  
3
